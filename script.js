...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const urunler = {
        "exploit": { isim: "Exploit Developer", fiyat: "7.900 ₺", img: "gorseller/gorsel4.webp", aciklama: "Sıfırıncı gün zafiyetleri üzerinde çalışan, yüksek seviyeli exploit geliştirme ve analiz serisi.", link: "https://www.shopier.com/xeroelite/48673614" },
        "pentest": { isim: "Pentester & Red Teamer", fiyat: "5.900 ₺", img: "gorseller/gorsel5.webp", aciklama: "Ağ ve sistemlere yönelik ileri düzey sızma testleri ve Red Team operasyon simülasyonları.", link: "https://www.shopier.com/xeroelite/48673662" },
        "malware": { isim: "Malware Analyst & Reverse", fiyat: "5.900 ₺", img: "gorseller/gorsel6.webp", aciklama: "Zararlı yazılım analizi ve tersine mühendislik teknikleriyle tehditleri kaynağında çözme eğitimi.", link: "https://www.shopier.com/xeroelite/48673679" },
        "web_mobile": { isim: "Web & Mobile App Sec", fiyat: "4.900 ₺", img: "gorseller/gorsel7.webp", aciklama: "Web uygulamaları ve mobil platformlarda (iOS/Android) güvenlik zafiyetlerinin tespiti ve yamalanması.", link: "https://www.shopier.com/xeroelite/48673697" },
        "cloud_network": { isim: "Cloud & Infrastructure / Network Security", fiyat: "3.900 ₺", img: "gorseller/gorsel8.webp", aciklama: "Bulut mimarileri ve ağ altyapılarına yönelik modern güvenlik protokolleri ve sıfır güven (Zero Trust) yaklaşımı.", link: "https://www.shopier.com/xeroelite/48673721" },
        "soc": { isim: "SOC & Incident Response", fiyat: "3.900 ₺", img: "gorseller/gorsel9.webp", aciklama: "Kurumsal ağlarda anlık tehdit tespiti, olay müdahalesi ve Blue Team savunma stratejileri.", link: "https://www.shopier.com/xeroelite/48673772" },
        "cyber_intel": { isim: "Cyber Intelligence", fiyat: "3.900 ₺", img: "gorseller/gorsel10.webp", aciklama: "Açık kaynak istihbaratı (OSINT) ve siber tehdit istihbaratı yöntemleriyle veri toplama ve analizi.", link: "https://www.shopier.com/xeroelite/48673826" },
        
        "hizmet_pentest": { isim: "Gelişmiş Pentest Hizmeti", fiyat: "11.900 ₺", img: "gorseller/gorsel12.webp", aciklama: "Kurumsal ağlarınız ve sistemleriniz için en üst düzey güvenlik açığı tespiti ve sızma testi hizmeti.", link: "https://www.shopier.com/xeroelite/48674021" },
        "hizmet_blockchain": { isim: "Blockchain Güvenlik Hizmeti", fiyat: "6.900 ₺", img: "gorseller/gorsel13.webp", aciklama: "Akıllı kontratlar ve Web3 projeleriniz için ileri seviye zafiyet taraması ve mimari denetim.", link: "https://www.shopier.com/xeroelite/48674042" },
        "hizmet_web_app": { isim: "Web ve Uygulama Güvenliği", fiyat: "11.900 ₺", img: "gorseller/gorsel14.webp", aciklama: "Web ve mobil uygulamalarınızın (iOS/Android) hacker bakış açısıyla incelenip güvenli hale getirilmesi.", link: "https://www.shopier.com/xeroelite/48674062" },
